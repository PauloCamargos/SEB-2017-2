...
#define LD_BUTTON 7       // Bot�o liga-desliga do sistema
#define FR_BUTTON 6       // Bot�o frei magn�tico do sistema
#define POT_V A0          // Pino de leitura da tens�o no potenciometro
...
////////////////
/**
   Iniciliza os pinos como saidas e entradas e tambem a comunica��o serial
*/
void setup() {
  /* Informa��es da classe motor*/
  ...
  //Vari�veis internas do programa (botoes)
...
/**
   ...
   - Controle do motor de acordo com os bot�es
*/
void loop() {
