...
float lerTensao() {
  ...
  //int  tensao_int = map(valorSensor,0,1023,0,500); // SOMENTE UNO
  float tensao = valorSensor * (3.3 / 676); // SOMENTE UNO
  //int  tensao_int = map(valorSensor, 0, 676, 0, 330); // SOMENTE DUE
  // float tensao = tensao_int / 100.0; //SOMENTE DUE
  return tensao;
}
